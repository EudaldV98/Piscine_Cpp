...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/26 13:16:22 by jvaquer           #+#    #+#             */
/*   Updated: 2021/01/26 13:19:48 by jvaquer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "Try emty with empty stack : " << mylist.empty() << std::endl;
	mylist.push(75.1);
	mylist.push(23.2);
	mylist.push(65.3);
	mylist.push(42.4);
	...
	std::cout << "\nCopy the precedent list, pop the last value and push 1000" << std::endl;
